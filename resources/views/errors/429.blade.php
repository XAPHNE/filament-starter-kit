    ...
    <div class="flex flex-col gap-6 text-center">
        ...
        <div class="p-4 rounded-lg bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
            ...
            <div class="flex flex-col gap-3 mt-6">
                <a id="try-again-btn" data-href="{{ filament()->getLoginUrl() }}" class="w-full inline-flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-zinc-900 hover:bg-zinc-800 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zinc-500 transition-all opacity-50 pointer-events-none">
                    {{ __('Try Again') }}
                </a>
                <a href="{{ url('/') }}" class="w-full inline-flex justify-center py-2.5 px-4 border border-zinc-200 dark:border-zinc-800 rounded-lg text-sm font-semibold text-zinc-900 dark:text-zinc-100 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zinc-500 transition-all">
                    {{ __('Return Home') }}
                </a>
            </div>
        </div>
